...
<strong>NB: the following needs to be re-written for 2.0...</strong>
...
The file "phantom-runner.js":https://github.com/kyleburton/transition.js/blob/master/examples/phantom-runner.js can be used to execute your test suite using "Phantom.js":http://phantomjs.org for automated, headless testing.  The @Rakefile@ that is part of Transtion.js has an installer for Phantom.js:
