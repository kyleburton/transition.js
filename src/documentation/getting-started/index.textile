...
The Frames based testing framework allwows you to interactively test your application, watch its progress, and single stepping your test.  The Frames style tests can be run from any browser.  I have found these tests to be valuable when testing mulitple devices.  Being able to bring up the test on a mobile phone, a challenging environemnt in which to test, and step the test has been fantastic.
...
<html>
  ...
  <div id="test-navigation">
    ...
    <button id="step-test">Step</button>
    <button id="continue-test">Continue</button>
    <button id="reset-console">Clear Console</button>
  </div>
